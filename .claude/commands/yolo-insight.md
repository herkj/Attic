# /yolo-insight - Fully automatic session pipeline
...
4. Check for `config/taxonomy/custom.yaml` - if it exists, merge as third layer
5. Merge and format as flat list per category for use in extraction
