# User Research Synthesis Skill (Anthropic)

> Source: github.com/anthropics/knowledge-work-plugins/product-management/skills/user-research-synthesis/SKILL.md
...
- Show the math: "Based on support ticket volume, approximately 2,000 users per month encounter this issue."
